    ...
    <div class="py-10">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-10">
            ...
            <div class="bg-white p-6 shadow-lg rounded-xl">
                ...
                <p class="text-gray-700"><strong>Naam:</strong> {{ Auth::user()->name }}</p>
                <p class="text-gray-700"><strong>E-mailadres:</strong> {{ Auth::user()->email }}</p>
            ...
            @if(Auth::user()->is_admin)
                <div class="bg-yellow-50 p-6 shadow-lg rounded-xl">
                    <h3 class="text-lg font-semibold mb-4 text-yellow-800">Admin statistieken</h3>

                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        <div class="p-4 bg-white rounded-xl shadow text-center">
                            <p class="font-bold text-2xl text-gray-800">{{ \App\Models\User::count() }}</p>
                            <span class="text-gray-600 text-sm">Gebruikers</span>
                        </div>

                        <div class="p-4 bg-white rounded-xl shadow text-center">
                            <p class="font-bold text-2xl text-gray-800">{{ \App\Models\News::count() }}</p>
                            <span class="text-gray-600 text-sm">Nieuwsberichten</span>
                        </div>

                        <div class="p-4 bg-white rounded-xl shadow text-center">
                            <p class="font-bold text-2xl text-gray-800">{{ \App\Models\Contact::count() }}</p>
                            <span class="text-gray-600 text-sm">Contactberichten</span>
                        </div>

                        <div class="p-4 bg-white rounded-xl shadow text-center">
                            <p class="font-bold text-2xl text-gray-800">{{ \App\Models\Comment::count() }}</p>
...
{{-- DEBUG CHECK --}}
<p class="text-center text-red-500 font-bold">DASHBOARD VIEW IS GELADEN</p>
